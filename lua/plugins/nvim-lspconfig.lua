    ...
    config = function()
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>lgd', require('telescope.builtin').lsp_definitions, '[G]oto [D]efinition') -- To jump back, press <C-T>
      ...
      require('mason').setup()
      vim.keymap.set('n', '<leader>lm', ":Mason<CR>", { desc = '[M]ason configuration' })
